        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="h-11 px-6 rounded-lg bg-[#7A4DBE] text-white text-sm font-semibold hover:bg-[#6a3da8] transition-colors shadow-lg shadow-[#7A4DBE]/25">
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed bottom-0 left-0 w-full p-4 bg-[#050505]/90 backdrop-blur-lg border-t border-white/[0.08] z-40 pb-safe">
        <button className="w-full h-12 rounded-lg bg-[#7A4DBE] text-white font-semibold shadow-lg shadow-[#7A4DBE]/25 flex items-center justify-center">
          Get Free Audit
        </button>
      </div>
    </>
